...
export default function SubscriptionCard({
    ...
    return (
        <>
            {/* <!-- Basic --> */}
            {!isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 border border-black outline outline-5 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content]">
                    ...
                    <div className="flex flex-col gap-4">
                        {features.map((feature, index) => (
                            <div
                                ...
                                key={`${index}-${id}-${feature}`} //jadi features kalo di tutorial
                            >
            ...
            {isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                    ...
                    {/* <!-- Bottom: CTA Button --> */}
                    <div onClick={onSelectSubscription}>
                        <PrimaryButton type="button" className="bg-alerange">
